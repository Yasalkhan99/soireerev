                ...
                <div className="row">
                  <div className="col-12">
                    <div className="banner__content">
                      <h1 className="text-uppercase text-start fw-9 mb-0 title-anim">Project Details</h1>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="row">
                  <div className="col-12 col-lg-8 offset-lg-2">
                    <div className="section__content">
                      <Image src="/assets/images/projects/one.png" alt="Project" width={800} height={500} className="mb-4" />
                      <h2 className="title mb-4">Digital Marketing Campaign</h2>
