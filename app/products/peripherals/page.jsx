          ...
          <main>
            ...
            <section className="section portfolio pb-0 fade-wrapper position-relative">
              <div className="portfolio__text-slider">
                {[
                  { id: 1, title: "Peripherals" },
                  { id: 2, title: "Peripherals" },
                  { id: 3, title: "Peripherals" },
                  { id: 4, title: "Peripherals" },
                  { id: 5, title: "Peripherals" },
                  { id: 6, title: "Peripherals" },
                  { id: 7, title: "Peripherals" },
                ].map((i) => (
              ...
              <div className="container-fluid">
                <div className="row gaper">
                  {[
                    ...
                    { img: "/assets/images/p4.png", title: "Printer Roll" },
                    { img: "/assets/images/p5.png", title: "Weight Scale" },
                    {
