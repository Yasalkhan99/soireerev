                ...
                <div className="row">
                  <div className="col-12">
                    <div className="banner__content">
                      <h1 className="text-uppercase text-start fw-9 mb-0 title-anim">Team Details</h1>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="row">
                  <div className="col-12 col-lg-8 offset-lg-2">
                    <div className="section__content text-center">
                      <Image src="/assets/images/teams/one.png" alt="Team Member" width={400} height={500} className="mb-4" />
                      <h2 className="title mb-3">John Doe</h2>
                      <p className="sub-title mb-4">CEO & Founder</p>
