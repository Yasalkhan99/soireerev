...
export default function Footer() {
  ...
  return (
    <footer className="footer section pb-0" data-background="/assets/images/footer/footer-bg.png">
                ...
                <div className="footer__single-form">
                  <form action="#" method="post">
                    <div className="input-email">
                      <input type="email" name="subscribe-news" id="subscribeNews" placeholder="Enter Your Email" required />
              ...
              <div className="row align-items-center gaper">
                <div className="col-12 col-lg-8">
                  <div className="footer__copyright-text text-center text-lg-start">
                    <p>
                      Copyright &copy; {currentYear} SoireInc. All Rights Reserved
                    </p>
                  </div>
                </div>
